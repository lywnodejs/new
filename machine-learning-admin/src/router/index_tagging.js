...
const erroranalysisdetail = () => import('@/pages/mxxl/erroranalysisDetail');//错误分析修改详情
const nererror = () => import('@/pages/mxxl/nererror');//NER错误分析修改
//模型测试相关
...
export default new Router({
  routes: [{
    ...
    children: [{
      ...
      path: '/erroranalysisdetail',
      component: erroranalysisdetail,
      name: '错误分析修改详情',
    }, {
      path: '/nererror',
      component: nererror,

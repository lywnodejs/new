    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <el-menu default-active="1" class="el-menu-vertical-demo branchOfficeListf" @open="handleOpen" @close="handleClose" unique-opened v-show="!collapsed">
          ...
          <!-- <el-submenu index="11"> -->
            <!-- <template slot="title"><i class="fa fa-calendar"></i> -->
              <!-- 资讯审核</template> -->
<!--            <el-menu-item  index="1-1" @click="goPage('/information')">资讯列表</el-menu-item>-->
<!--            <el-menu-item  index="1-2" @click="goPage('/changedInformation')">已修正资讯列表</el-menu-item>-->
            <!-- <el-menu-item  index="1-3" @click="goPage('/riskInformationList')">风险列表</el-menu-item> -->
          </el-submenu>
<!--  -->
<!--          <el-submenu index="12">-->
<!--            <template slot="title"><i class="fa fa-calendar"></i>-->
<!--              权限设置</template>-->
<!--            <el-menu-item  index="1-1" @click="goPage('/setPermission')">权限分配</el-menu-item>-->
<!--          </el-submenu>-->
          <el-submenu index="13" v-if="menuList.indexOf('eoperation:hczqinfo:view') == -1 ? false : true ">
            <template slot="title"><i class="fa fa-calendar"></i>
              华创官网内容维护</template>
            <el-menu-item v-if="menuList.indexOf('eoperation:hczqinfo:view') == -1 ? false : true "  index="1-1" @click="goPage('/contentMaintain')">内容维护</el-menu-item>
            <!-- <el-menu-item  index="1-2" @click="goPage('/sendSubject')">权限管理</el-menu-item> -->
          </el-submenu>
        </el-menu>
...
//        console.log(result)
    ...
    enterToPage: function () {
      ...
      if (_this.menuList.indexOf('quota:view') !== -1) {
        ...
        return false
      } else if (_this.menuList.indexOf('eoperation:hczqinfo:view') !== -1) {
        _this.$router.push('/contentMaintain')
        return false
      }
    }
  },

      ...
      <view class="container-list">
        ...
        >
          <label class="content">
            ...
            <view
              class="checkbox"
              v-if="isCheck&&!props.multiple&&props.nodes&&item.user"
              @click.stop="checkbox(item,index)"
            >
              <i
                v-if="newCheckList.length>0&&item.id == newCheckList[0].id"
            ...
            <view
              class="checkbox"
              v-if="isCheck&&!props.multiple&&!props.nodes"
              @click.stop="checkbox(item,index)"
            >
              <i
                v-if="newCheckList.length>0&&item.id == newCheckList[0].id"

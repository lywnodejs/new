 ...
 * @description
 */
define('js/redirect-page/index',['require','exports','module','../common/app','../common/utils','../common/filter/application-filter'],function (require, exports, module) {
    ...
    app.controller('redirect-page', ['$rootScope', '$scope', '$http', '$timeout', '$filter',
        function ($rootScope, $scope, $http, $timeout, $filter) {
            ...
            $http({
                ...
                window.location.href = "/project/portals/pages/" + $filter('getRedirectPage')(res.data.buttonState) + ".html?id=" + urlData.id;
            });
        }
    ]);

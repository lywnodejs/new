...
define('js/common/app-list-init',['require','exports','module','./service/service','../../common/directive/loading/loading','./filter/application-filter','./filter/filter'],function (require, exports, module) {
 ...
 define('js/bug-noauth/index',['require','exports','module','../common/utils','../common/app','../common/app-list-init'],function (require, exports, module) {
     var utils = require('../common/utils');
     var app = require('../common/app');
     require('../common/app-list-init')(app);
     var urlData = utils.getUrlData();
     app.controller('bug-noauth-ctrl', ['$rootScope', '$scope', '$http', '$timeout', '$filter', 'mypagination',

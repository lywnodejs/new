              ...
              <el-row type="flex" class="row-bg" justify="end">
                <el-col :span="4">
                  <el-form-item label="评估分类">
                    <el-select clearable v-model="form.scope_type" placeholder="选择分类">
...
export default {
  ...
  methods: {
    ...
    vulListParams() {
      ...
      //   scope_type 评估分类 
      if (this.form.scope_type) {
        params['scope_type'] = this.form.scope_type
      }
      // assessment_self_ret 自评结果

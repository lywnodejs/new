            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                      <el-button class="fontColor" @click="openDialog('look', scope.row)"
                        type="text"
                        size="mini">查看
                      </el-button>
                      <el-button class="fontColor" @click="openDialog('edit', scope.row)"
                          type="text"
                          size="mini">编辑
                      </el-button>
                      <el-button class="fontColor" type="text" size="mini" v-show="scope.row.is_disable==1" @click="enableWhite(scope.row.white_rule_id)">启用</el-button>
                      <el-button class="fontColor" type="text" size="mini" v-show="scope.row.is_disable==0" @click="disableWhite(scope.row.white_rule_id)">禁用</el-button>
                      <el-button class="fontColor" @click="openDialog('vul', scope.row.white_rule_id);"
                                 type="text"
                                 size="mini">漏洞知识
                      </el-button>
                      <el-button class="fontColor" @click="openDialog('solution', scope.row.white_rule_id)"
                                 type="text"
                                 size="mini">安全方案
                      </el-button>
                    </template>
...
import whiteLanguage from '../../dolphin/testBaseManagement/components/language'

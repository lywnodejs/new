      ...
      <el-row :gutter="20">
        <el-col :span="24">
          <div class="content-chart">
            <div id="baseline-by-scanTaskByID" class="chart-content"></div>
    ...
    methods: {
      fetchData() {
          ...
          this.baselineCheckIssueById(param).then(res => {
              this.checkIssueInfo = res.time_interval
              this.data = [
                  ['人工审计时间', parseFloat(this.handleTimeByDay(this.checkIssueInfo)), this.handleTime(this.checkIssueInfo)]
              ]
      ...
      drawBaselineChart(res) {
        let baselineChart = echarts.init(document.getElementById('baseline-by-scanTaskByID'))
        let option = {
          ...
          tooltip: {
              trigger: 'axis',
                        formatter: function(params) {
                            let str = '人工审计时间：' + params[0].data[2]
                            return str
                        }
          },
          toolbox: {

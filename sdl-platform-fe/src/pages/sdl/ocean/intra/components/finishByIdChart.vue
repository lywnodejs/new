<template>
  <div id="ocean-baseline-baselineByID-chart">
       
      <el-row :gutter="20">
        <el-col :span="24">
          <div class="content-chart">
            <div id="baseline-by-baselineByID" class="chart-content"></div>
    ...
    methods: {
      fetchData() {
          ...
          this.baselineFinishById(param).then(res => {
              ...
              this.data = [
                  ['项目完成时间', parseFloat(this.handleTimeByDay(this.finishInfo)), this.handleTime(this.finishInfo)]
              ]
      ...
      drawBaselineChart(res) {
        let baselineChart = echarts.init(document.getElementById('baseline-by-baselineByID'))
        let option = {
          ...
          tooltip: {
            trigger: 'axis',
                        formatter: function(params) {
                            let str = '项目完成时间：' + params[0].data[2]
                            return str
                        }
          },
          toolbox: {
            ...
            feature: {
              dataView: {
                ...
                optionToContent: function(opt) {
                  ...
                  let str = `<div class="content"><span class="color1 point">• </span>${data[0]}：<span class="color1 ">${data[2]}</span></div>`
                  return str
                }
              }
            }
...
<style lang="less">
#ocean-baseline-baselineByID-chart{
    .content-chart {

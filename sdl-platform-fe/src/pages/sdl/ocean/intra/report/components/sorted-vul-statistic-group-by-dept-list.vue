<template>
  <div id="sorted-vul-statistic-group-by-dept-list" >
  </div>
</template>
<script>
  ...
  export default connect(() => {
    ...
    methods: {
      ...
      drawChat(data) {
        ...
        let myChart = echarts.init(document.getElementById('sorted-vul-statistic-group-by-dept-list'))
...
<style lang="less">
#sorted-vul-statistic-group-by-dept-list{
    padding-top: 100px;
    width: 100%;
    height:460px;
    margin: 0 auto;

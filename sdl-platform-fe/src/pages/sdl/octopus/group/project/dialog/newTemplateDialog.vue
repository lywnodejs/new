<template>
       <el-dialog id="octopus-group-project-template-dialog"
                title="新建模板"
    ...
    <div  v-show="resultGroupFilter.length!=0" class="cutLine"></div>
    <div  v-show="resultGroupFilter.length!=0" class="title">身份认证参数标注</div>
    <el-card v-show="resultGroupFilter.length!=0"
     :body-style="{ padding: '0px' }" shadow="never" class="box-card">
       <!-- <div slot="header" class="clearfix">
        ...
        <!-- <div class="elCardBorder">
        <div class="bottom clearfix">

          <el-button type="text" @click="addNewList">新增list</el-button>
         <el-button  type="text" @click="updateTemplate">上传</el-button>
        </div>
      </div> -->
    </el-card>
     <el-button  v-show="resultGroupFilter.length!=0" type="text" @click="addNewList" class="newListButton">+ 新增认证参数组</el-button>
         <!-- <el-button  type="text" @click="updateTemplate">上传</el-button> -->
      <span slot="footer" class="dialog-footer">
        <el-button  v-show="resultGroupFilter.length!=0" class="octopus-diaolog-button" @click="dialogFormVisible = false">取消</el-button>
        <el-button  v-show="resultGroupFilter.length!=0" class="octopus-diaolog-btn" type="primary" @click="updateTemplate">保存</el-button>
      </span>
    </el-dialog>
</template>
...
export default connect(() => {
  return {
      sessionID: 'octopus_group/sessionID'
  }
}, {
    newSession: 'octopus_group/newSession',
...
<style lang="less">
#octopus-group-project-template-dialog{
    .title{
        font-weight: bold;
        margin-bottom: 15px;
    }

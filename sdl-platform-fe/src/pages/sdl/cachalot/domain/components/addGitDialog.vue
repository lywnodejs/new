...
export default connect(() => {
  ...
  modifyDomain: 'cachalot_domain/modifyDomain'
})({
  props: ['visible', 'data'],
  data() {
    return {
  ...
  watch: {
    ...
    data(val) {
        this.queryParam.domain_id = val.domain_id
        this.queryParam.git_url = val.git_url ? val.git_url : []
    }
  },
  methods: {
    updateInfo() {
        this.modifyDomain(this.queryParam).then(res => {

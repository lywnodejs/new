...
export default connect(() => {
    return {
      ...
      sendVideoComment: 'dolphin_mooc/sendVideoComment',
      getVideoComment: 'dolphin_mooc/getVideoComment'
  })({
  name: '',
  data() {
    return {

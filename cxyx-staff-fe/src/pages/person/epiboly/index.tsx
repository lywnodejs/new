...
export const Epiboly = () => {
  ...
  const fetchData = params => {
    setSelectedRowKeys([]);
    setLdaps([]); // 清空已选
    return fetchFormalList({ ...params, employType: 'outAcc' }).then(
      (res: any) => {
        return res;
      },
    );
  ...
  return (
    <>
      ...
      <ImportPersonModal
        ...
        dataSource={PERSON_DATA_SOURCE_TYPE.EPIBOLY}
      />
    </>
  );
};
export default Epiboly;

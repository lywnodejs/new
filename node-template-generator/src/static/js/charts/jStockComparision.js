    ...
    getTarget: function (sn) {
        var temp =
            ...
            '<div class="nav_con show" id="chart0_nav_con' + sn + '">'+
                ...
                '</div>'+
                '<div class="nodata" style="display: none" id="box_chart0_nodata' + sn + '"><img src="images/nodata-min.png"></div>'+<!-- 无数据 -->
            '</div>'+
            '<div class="nav_con" id="chart1_nav_con' + sn + '">'+
                ...
                '</div>'+
                '<div class="nodata" style="display: none" id="box_chart1_nodata' + sn + '"><img src="images/nodata-min.png"></div>'+<!-- 无数据 -->
            '</div>'+
            '<div class="nav_con" id="chart2_nav_con' + sn + '">'+
                ...
                '</div>'+
                '<div class="nodata" style="display: none" id="box_chart2_nodata' + sn + '"><img src="images/nodata-min.png"></div>'+<!-- 无数据 -->
            '</div>'+
            '<div class="nav_con" id="chart3_nav_con' + sn + '">'+
                ...
                '</div>'+
                '<div class="nodata" style="display: none" id="box_chart3_nodata' + sn + '"><img src="mages/nodata-min.png"></div>'+<!-- 无数据 -->
            '</div>';
        return temp;
    },

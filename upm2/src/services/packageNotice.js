...
const searchAllNotice = (params) => {
  return request(mockPrefix + '/v2/packageCategoryIntroduce/list', { params });
};
 ...
 */
const searchOneNotice = (params) => {
  return request(mockPrefix + '/v2/packageCategoryIntroduce/getIntroduce', { params });
};
 ...
 * @configId {Number} 配置 id
 */
const delNotice = (params) => {
  return postJSON(mockPrefix + '/v2/packageCategoryIntroduce/delete', params, {
      silent: false
    });
};
...
const newNotice = (data) => {
  return postJSON(mockPrefix + '/v2/packageCategoryIntroduce/add', { ...data }, {
    silent: false
  });
};
...
const updateNotice = (data) => {
  return postJSON(mockPrefix + '/v2/packageCategoryIntroduce/update', { ...data }, {
    silent: false
  });
};

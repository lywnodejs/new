...
Component({
  ...
  methods: {
    ...
    onDetail(e) {
      wx.navigateTo({
        url: '/pages/my/depositList/detail/index?orderId=' + e.currentTarget.dataset.order.orderId + '&depositAmount=' + e.currentTarget.dataset.order.depositAmount + '&prospectiveYield=' + e.currentTarget.dataset.order.prospectiveYield + '&expireTime=' + e.currentTarget.dataset.order.expireTime + '&productName=' + e.currentTarget.dataset.order.productName + '&productId=' + e.currentTarget.dataset.order.productId
      })
    }
  }
})
...
export const RegisterStudentForm:React.FC<PropsState> = ({role}) => {
    const classes = useStyle();
    const enterPressed = useKeyPress(13);
    const [values, setValues] = useState<RegisterStudentState>({
        username: '',
        idCard: '',
        password1: '',
        password2: '',
    ...
    const handleChangeTextForms = (prop: keyof RegisterStudentState) =>
    ...
    const handleClickRegister = () => {
        ...
        if (
            ...
            return setValues({
                ...
                idCardErrorMessage: values.idCard === '' ? '身份证/学生证件号不能为空' : '',

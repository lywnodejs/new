...
const useStyles = makeStyles((theme: Theme) => createStyles({
    tab: {
        ...
        background: (theme.palette.type === "light" ? '#ececec' : '#161d26'),
        height: 50,
        position: 'fixed',
    ...
    tabUpDown: {
        backgroundColor: (theme.palette.type === "light" ? '#ececec' : '#161d26'),
        // transition: 'background-color 500ms',
        '&:hover': {
            backgroundColor: (theme.palette.type === "light" ? '#f7f7f7' : '#202834'),
        },
    },
}));
        ...
        <div className={classes.tab}>
            ...
            >
                {
                    openPagesTabs.map(tab => (
                        <SingleTab
                            ...
                            router={'/'}
                            icon={tab.icon}
                            isActive={values.openTab === tab.title}
                            openTab={(event) => handleOpenPageTab(event, tab.title)}
            ...
            <div
                className={clsx(classes.tabUpDown,
                    styles["tab-down"])} onClick={TabItemsToRight}
            >

...
const proxy = [
  ...
  },
  {
    name:'/topchtml/',
    options:{
      target: 'http://10.0.0.22:10008/',
      pathRewrite: {
        '/topchtml/': '/'
      },
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://10.0.0.22:10008/')
      }
    }
  },
  {
    name:'/e-html/',
    options:{
      target: 'http://10.0.0.105:8086/',
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://10.0.0.105:8086/'+req.url)
      }
    }
  },
  {
  ...
  },
  {
    name:'/cproject/',
    options:{
      target: 'http://c-project-dev.jinhui001.com/prospectus',
      pathRewrite: {
        '/cproject/': '/'
      },
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://c-project-dev.jinhui001.com/prospectus')
      }
    }
  },
  {
    ...
    options:{
      target: 'http://c-project-dev.jinhui001.com/prospectus/prospectus',
      pathRewrite: {
        '/cproject/prospectus/': '/'
      },
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://c-project-dev.jinhui001.com/prospectus/prospectus')
      }
    }
  },
  {

...
const proxy = [
  ...
  },
  {
    name:'/cproject/',
    options:{
      target: 'http://c-project.rxhui.com/prospectus',
      pathRewrite: {
        '/cproject/': '/'
      },
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://c-project.rxhui.com/prospectus')
      }
    }
  },
  {
    ...
    options:{
      target: 'http://c-project.rxhui.com/prospectus/prospectus',
      pathRewrite: {
        '/cproject/prospectus/': '/'
      },
      onProxyReq: function (reqProxy, req, res) {
        res.redirect('http://c-project.rxhui.com/prospectus/prospectus')
      }
    }
  },
  {

var sh_kLine = {
  ...
  getReport:function (d,col,open,close,zdf,chart_t) {
    ...
    var temp = '<span style=" display:block; width:300px; height:18px; line-height: 18px; margin: 0 auto;">'+
        '<span style="font-family: 微软雅黑;font-size: 0.75em;font-weight: normal; float: left; width: 24%; ">'+Highcharts.dateFormat('%Y-%m-%d',d)+'</span>'+
        ...
        '<span style=" float: left;color:'+col+';font-family: 微软雅黑;font-size: 0.75em;font-weight: normal">'+zdf+'</span></span>'+
        '</span>'
    $reporting.html(temp);
  }
